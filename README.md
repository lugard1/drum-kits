...
## Learning Objectives
- Understand how to replicate a cool Drum kits application which displays different items of the drum kits in a button that produce sounds on click it supports excellent user experience, and has beautiful user interface.

## Description of the Project
For the first milestone in the process of creating Drum kits application, you will:
